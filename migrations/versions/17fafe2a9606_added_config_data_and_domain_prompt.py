...
def upgrade():
    ...
    with op.batch_alter_table('processing_job', schema=None) as batch_op:
        batch_op.add_column(sa.Column('config_data', sa.String(), nullable=True, default=None))
        batch_op.add_column(sa.Column('domain_prompt', sa.String(), nullable=True, default=None))
